...
//        System.out.println(Arrays.toString(Solution.twoSum(new int[]{2, 25, 23, 576}, 48)));
//        System.out.println(Arrays.toString(Solution.twoSum(new int[]{2, 7, 11, 15, 16, 18, 32}, 50)));
//        System.out.println(Arrays.toString(Solution.twoSum(new int[]{1, 2, 4, 5, 6, 8, 9, 11, 12, 23}, 24)));
